...
- **Catalog** (`00`–`13`) — how the system is _laid out_: exhaustive coverage of every one of the 1039 tracked files, named or grouped by exact chezmoi source path. Use it to drill from a concept to the precise file.
