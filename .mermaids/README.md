...
- **Catalog** (`00`–`13`) — how the system is _laid out_: exhaustive coverage of every one of the 1150 tracked files, named or grouped by exact chezmoi source path. Use it to drill from a concept to the precise file.
...
12. [`07c-bin-commands.mmd`](07c-bin-commands.mmd) — every script in `exact_bin/` (86) grouped by purpose + the `,w` internals.
