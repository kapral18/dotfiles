...
- **Catalog** (`00`–`13`) — how the system is _laid out_: exhaustive coverage of every one of the 1265 tracked files, named or grouped by exact chezmoi source path. Use it to drill from a concept to the precise file.
...
16. [`11-scripts-helpers.mmd`](11-scripts-helpers.mmd) — every file in `scripts/` (66): shared parsers, MCP/model generators, AI KB, tests.
