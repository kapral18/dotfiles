...
- **Catalog** (`00`–`13`) — how the system is _laid out_: exhaustive coverage of every one of the 1016 tracked files, named or grouped by exact chezmoi source path. Use it to drill from a concept to the precise file.
...
5. [`03b-agent-skills-hooks.mmd`](03b-agent-skills-hooks.mmd) — every file under `exact_dot_agents/` (32 skills + 8 hooks + references).
...
16. [`11-scripts-helpers.mmd`](11-scripts-helpers.mmd) — every file in `scripts/` (45): shared parsers, MCP/model generators, AI KB, tests.
