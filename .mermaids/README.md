...
- **Catalog** (`00`–`13`) — how the system is _laid out_: exhaustive coverage of every one of the 870 tracked files (`git ls-files`), named or grouped by exact chezmoi source path. Use it to drill from a concept to the precise file.
...
11. [`07b-neovim.mmd`](07b-neovim.mmd) — every file under `exact_nvim/` (136): core, 57 plugin specs, 14 local plugins, util, queries, syntax.
