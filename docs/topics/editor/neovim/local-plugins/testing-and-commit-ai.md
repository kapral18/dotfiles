...
| ---------- | -------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| OpenRouter | `OPENROUTER_API_KEY` | None. The route is fixed to `z-ai/glm-5.3-flash` with `reasoning.effort: "high"`, no `provider.sort` (uptime-aware default LB), `preferred_min_throughput: 300`, and `max_tokens: 131072` (top-provider max completion; 1,048,576-token context). OpenRouter deprioritizes slower endpoints rather than hard-excluding them. Independent of the DeepSeek wrapper/Pi/OMP route. |
