...
| ---------- | -------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| OpenRouter | `OPENROUTER_API_KEY` | None. The route is fixed to `openai/gpt-oss-120b` with `reasoning.effort: "high"` (catalog max: high/medium/low), `provider.sort: "price"`, `preferred_min_throughput: 300`, and `max_tokens: 131072` (endpoint max completion / 131072-token context). OpenRouter deprioritizes slower endpoints rather than hard-excluding them. Independent of the DeepSeek wrapper/Pi/OMP route. |
