...
Provenance enumerates every contributing config or registry source. Registry entries also name sections, such as `agent_bindings`, `agent_categories`, and `category_models` for review-policy routing.
