...
- **PR necessity gate** is first and blocking for other-authored or unknown-author PRs: read the PR, references, history, and overlaps before spending reviewer/UI time. If it does not greenlight the PR as worth implementation review, stop and surface PR-level feedback.
