...
| Execution  | Subagents, reviews, `/build`, and Palantír legions                         | [Cross-harness subagents](subagents.md), [Review workflow](reviews/index.md), [Creation workflow](creation-workflow.md), [Palantír orchestrator](palantir.md) |
