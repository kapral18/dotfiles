...
| `advisor.enabled`                                                                      | `true` (subagents false, syncBacklog 1, immuneTurns 0)                                            | same                                                       |
