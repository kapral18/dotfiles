...
| [`diskonaut`](https://github.com/imsnif/diskonaut), [`dua-cli`](https://lib.rs/crates/dua-cli), [`disko`](https://github.com/cesarferreira/disko), [`grandperspective`](https://grandperspectiv.sourceforge.net/) | `brew` / `cargo` / `cask` | disk usage visualization                       |
