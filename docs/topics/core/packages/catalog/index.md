...
| [Languages and runtimes](languages-and-runtimes.md)                        | mise, uv Python versions, Cargo/Go/Ruby/pnpm/uv global packages                       |
...
| [pnpm](https://pnpm.io/) globals                                                                                       | [`home/readonly_dot_default-pnpm-pkgs`](../../../../../home/readonly_dot_default-pnpm-pkgs)                                                                                                |
...
| `pnpm`, `uv`, `cargo`, `go`, `gem`, `mise` | language/runtime manager source                |
