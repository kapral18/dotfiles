...
| Command      | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| ------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `,kbn-stack` | Spin up an isolated ES + Kibana stack for the current worktree: auto-allocates a slot (unique port, cookie name, encryption key) so many worktrees run in parallel without `/etc/hosts`; `--es snapshot` (default, fully parallel) or `--es serverless` (single-instance: kbn-es runs fixed `es01`/`es02` containers, so serverless pins to slot 0, auto-stops any existing serverless stack first, and refuses to start over a snapshot stack on the conflicting low ports); keeps `--data`/`-E` flexibility. Interactive default runs ES in the current tmux pane and auto-launches Kibana in a second pane once ES is ready (splits the window if only one pane exists, reuses an existing 2-pane layout otherwise). `--detach` is the agent mode: starts ES + Kibana headless in the background, waits until Kibana answers `/api/status`, marks the stack `ready` in the registry, then returns. `--stop` tears down the current worktree's stack only when recorded detached/serverless processes are available, then drops its registry entry; `--stop-all` tears down registered detached/serverless stacks and leaves interactive tmux entries in the registry because they must be stopped from tmux |
