...
| `,ralph`               | Start, resume, inspect, and control Ralph multi-agent orchestration runs; `doctor --live-models` performs an opt-in, non-mutating Cursor catalog drift check                                                                                                                                                |
