...
| `,artifact`            | Create cache-only local HTML artifacts, inject feedback overlays into live browser pages, and collect batched browser feedback without writing into the worktree                          |
