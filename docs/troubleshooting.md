...
[`home/.chezmoi.toml.tmpl`](../home/.chezmoi.toml.tmpl) exits early if you
answer "no" to "Is 1Password ready". Make sure the 1Password app is installed,
unlocked, and the SSH agent is available.
