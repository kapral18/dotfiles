...
CENSUS: list[Claim] = [
    Claim(
        ...
        claimed=1416,
        anchors=[
            ("README.md", "1416 files in the effective git file set"),
            ("00-overview.mmd", "1416 files in the effective git file set"),
            ("00-overview.mmd", "file census (1416 total)"),
        ],
    ),
    Claim(
    ...
    Claim(
        ...
        claimed=116,
        anchors=[("05-tmux-pickers.mmd", "exact_tmux/ (116)"), ("00-overview.mmd", "tmux 116")],
    ),
    Claim(
    ...
    Claim(
        ...
        claimed=84,
        anchors=[
            ("07c-bin-commands.mmd", "exact_bin/ (84 thin commands)"),
            ("README.md", "`exact_bin/` (84)"),
            ("00-overview.mmd", "bin 84"),
        ],
    ),
    Claim(
        name="home/exact_lib/",
        ...
        claimed=95,
        anchors=[
            ("07c-bin-commands.mmd", "home/exact_lib/ (95 command/shared library files)"),
            ("README.md", "`home/exact_lib/` (95 command/shared library files)"),
            ("README.md", "38 command libraries plus shared helpers"),
            ("00-overview.mmd", "command-lib 95 (38 command dirs + shared)"),
        ],
    ),
    Claim(
        name="docs/",
    ...
    Claim(
        ...
        claimed=129,
        anchors=[
            ("03b-agent-skills-hooks.mmd", "exact_dot_agents/ (129)"),
            ("00-overview.mmd", "agents 129"),
        ],
    ),
    Claim(
        name="scripts/",
        ...
        claimed=135,
        anchors=[
            ("11-scripts-helpers.mmd", "scripts/ (135)"),
            ("README.md", "`scripts/` (135)"),
            ("00-overview.mmd", "scripts 135"),
        ],
    ),
]
