...
CENSUS: list[Claim] = [
    Claim(
        ...
        globs=None,
        claimed=942,
        anchors=[("README.md", "942 tracked files")],
    ),
    Claim(
    ...
    Claim(
        ...
        claimed=79,
        anchors=[
            ("07c-bin-commands.mmd", "exact_bin/ (79 incl. utils)"),
    ...
    Claim(
        ...
        claimed=53,
        anchors=[("03b-agent-skills-hooks.mmd", "exact_dot_agents/ (53)")],
    ),
    Claim(
        name="scripts/",
        globs=["scripts/*"],
        claimed=41,
        anchors=[
            ("11-scripts-helpers.mmd", "scripts/ (41)"),
            ("README.md", "`scripts/` (41)"),
        ],
    ),
]
