...
CENSUS: list[Claim] = [
    ...
    Claim(
        ...
        claimed=117,
        anchors=[
            ("03b-agent-skills-hooks.mmd", "exact_dot_agents/ (117)"),
            ("00-overview.mmd", "agents 117"),
        ],
    ),
    Claim(
        name="scripts/",
        ...
        claimed=112,
        anchors=[
            ("11-scripts-helpers.mmd", "scripts/ (112)"),
            ("README.md", "`scripts/` (112)"),
            ("00-overview.mmd", "scripts 112"),
        ],
    ),
]
