...
// OMP runtime defaults and safety hooks that mirror the shared Cursor contracts.
...
const BLOCK_REASON = "Git commit/push requires explicit approval; the OMP safety gate refused this command."
