// Managed by chezmoi (source: home/dot_omp/private_agent/extensions/ai-kb-recall.ts).
// Shared session context and durable-memory recall for OMP.
//
...
//   - OMP lifecycle state and persisted per-session recall dedupe stay here
//
