...
local rg_opts = common_utils.fzf_rg_opts
local rg_opts_unrestricted = common_utils.fzf_rg_opts_unrestricted
local fd_opts_unrestricted = common_utils.fzf_fd_opts_unrestricted
