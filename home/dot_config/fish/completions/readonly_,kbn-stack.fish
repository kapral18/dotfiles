...
complete -c ,kbn-stack -l stop -d "Tear down this worktree's stack and drop its registry entry"
complete -c ,kbn-stack -l stop-all -d "Tear down every registered stack and clear the registry"
