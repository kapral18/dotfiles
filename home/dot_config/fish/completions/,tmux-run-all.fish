...
function __f_tmux_run_all_tmux_sessions
    if __comma_is_completing_option
        return
    end
...
complete -c ,tmux-run-all -n '__fish_is_first_token; and not __comma_is_completing_option' -f -a "(__f_tmux_run_all_tmux_sessions)" -d "Session pattern"
complete -c ,tmux-run-all -n "__fish_seen_subcommand_from (__f_tmux_run_all_tmux_sessions); and not __comma_is_completing_option" -f -a "(__f_tmux_run_all_tmux_sessions)" -d "Exclude pattern"
