complete -c ,claude-copilot -s m -l model -d "Select a Copilot model" -x -a "claude-sonnet-5 claude-sonnet-4.6 claude-sonnet-4.5 claude-haiku-4.5 claude-fable-5 claude-fable-5.1 claude-opus-4.8 claude-opus-4.8-fast claude-opus-4.7 claude-opus-4.6 claude-opus-4.5 gpt-5.6-sol gpt-5.5 gpt-5.6-terra gpt-5.6-luna gpt-5.4 gpt-5.3-codex gpt-5.4-mini gpt-5-mini gemini-3.1-pro-preview gemini-3.5-flash"
