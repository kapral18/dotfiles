...
complete -c ',copilot-openrouter' -s m -l model -x -a '(__openrouter_catalog_models)' -d 'OpenRouter model id (default z-ai/glm-5.3-flash)'
complete -c ',copilot-openrouter' -l effort -x -a '(__openrouter_catalog_efforts)' -d 'Reasoning effort (default high; none disables)'
...
complete -c ',copilot-openrouter' -l context -x -a 'short long' -d 'Context tier (default long)'
