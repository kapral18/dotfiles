...
- `--domain` repeatable: pass each cross-cutting tech/topic tag separately (`--domain kibana --domain retrieval`). Domain tags are how `domain`-scoped recall finds the capsule across projects — omitting them strands it.
