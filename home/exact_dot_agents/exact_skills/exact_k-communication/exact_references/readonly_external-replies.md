# External Human Replies

Moved from always-loaded SOP §6.5. Apply every rule before drafting text another human will read.
In-session SOP §6 shape rules do not override this skill's friendly register.
