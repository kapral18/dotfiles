...
Before typed demos/videos that insert newlines, or troubleshooting swallowed Enter, MUST load and follow `~/.agents/skills/k-kibana-console-monaco/references/typed-demos.md`.
Use import for content setup; the reference owns the focus/widget diagnosis and complete `safeEnter` recipe.
