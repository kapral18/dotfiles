...
- the user asks `/k-improve-targeted`
...
- Recommend unrelated cleanup, package churn, or speculative abstractions only when the targeted part's evidence makes the payoff unusually clear.
