...
- Report readiness silently during normal flow; the caller surfaces only blockers.
- Use Playwriter evidence, never WebFetch, shell `curl`, or other HTTP-only probes, as local/private runtime readiness evidence.
