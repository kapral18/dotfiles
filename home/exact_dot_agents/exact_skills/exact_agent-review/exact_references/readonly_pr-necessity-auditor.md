...
- Keep searches bounded: search exact paths, issue/PR references, titles, and high-signal topic terms first. Do not dump broad search results; return only the hits read and what each proved.
