...
- For UI-related comments, replies, or PR-level feedback drafted after `/k-deep-review` or `k-agent-live-ui-review`, require screenshot handoff evidence outside the body or a valid blocker/non-applicability reason.
