...
- If recommending a change: name the single change, explain why it matters, cite the branch/PR/issue evidence, name the affected surfaces (consumers and co-edit set), and state the expected validation.
