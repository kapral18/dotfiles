...
- **"Does this logic / state model feel right?"** → load `~/.agents/skills/prototype/references/logic.md`.
  Build a tiny interactive terminal app that pushes the state machine through cases hard to reason about on paper.
- **"What should this look like?"** → load `~/.agents/skills/prototype/references/ui.md`.
