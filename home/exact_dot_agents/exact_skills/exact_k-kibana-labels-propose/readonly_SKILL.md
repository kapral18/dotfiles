...
- verify labels exist in the target repo; propose only labels you verified against the repo label set
...
- user asked to apply labels now:
  - use `~/.agents/skills/k-github/SKILL.md` (still requires explicit approval)
