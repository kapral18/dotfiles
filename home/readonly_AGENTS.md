...
**Instruction Hierarchy:** system > developer > workspace > user > this SOP. Check closest AGENTS.md first (project-local), then workspace-home. Use most specific rule; inherit others. On conflict, stop and ask user.
